<template>
  <div class="icon-list-box">
    ...
    <div class="btn-group">
      <lp-button @_click="cancel" type="warning" plain class="btn-cancel"
        >取消</lp-button
      >
      <lp-button @_click="confirm" type="success" plain class="btn-confirm"
        >确认</lp-button
      >
    </div>
  </div>
...
.active {
  ...
  background: rgba(194, 174, 174, 0.2);
}
.select-box {
  position: absolute;
  top: 0;
