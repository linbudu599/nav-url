...
.lp-button-danger {
  ...
  color: white;
  border: 1px solid rgba(222, 7, 7, 0.8);
}
...
.lp-button-success.is-plain {
  ...
  color: #61b836;
  border: 1px solid rgba(127, 201, 90, 0.5);
}
...
.lp-button-danger.is-plain {
  ...
  color: rgba(224, 63, 63, 0.9);
  border: 1px solid rgba(222, 7, 7, 0.2);
}
...
.lp-button-primary.is-plain {
  background: rgba(12, 148, 222, 0.1);
  color: #0c94de;
  border: 1px solid rgba(12, 148, 222, 0.35);
}
...
.lp-button-warning.is-plain {
  background: rgba(243, 154, 52, 0.1);
  color: #f39a34;
  border: 1px solid rgba(243, 154, 52, 0.4);
}
...
.lp-button-container.is-loading {
  cursor: not-allowed;
  opacity: 0.6;
