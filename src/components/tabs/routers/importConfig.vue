<template>
  <div class="import-config-container" v-show="isShow">
    <div class="import-config-alert">
      ...
      <div class="import-config-alert-remind">
      ...
      <form action="" class="form">
        <label for="import_config_input" class="import-config-label">
          ...
          <i
            v-if="hasFile == 1"
            class="fas fa-times-circle uploadErr uploadIcon"
          />
          <i
            v-else-if="hasFile == 2"
            class="fas fa-check-circle uploadSuccess uploadIcon"
          />
        </label>
        <input
      ...
      <lp-button type="primary" class="import-config-btn" @_click="importConfig"
        >确认上传</lp-button
      >
    </div>
  </div>
